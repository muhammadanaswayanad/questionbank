...
include("staffheader.php");
 ...
 $idd=$_GET["id"];
 $res = mysql_query("select * from studentreg where lid='$idd'");
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="354" border="1">
    <tr>
      ...
      <input type="text" name="textfield" id="textfield" value="<?php echo $row[1]; ?>" /></td>
    </tr>
    <tr>
      <td>Age</td>
      <td><label for="textfield2"></label>
      <input type="text" name="textfield2" id="textfield2" value="<?php echo $row[2]; ?>" /></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td><label for="textfield9"></label>
      <input type="text" name="textfield9" id="textfield9" value="<?php echo $row[3]; ?> " /></td>
    </tr>
    <tr>
      <td>House Name</td>
      <td><label for="textfield3"></label>
      <input type="text" name="textfield3" id="textfield3" value="<?php echo $row[4]; ?>" /></td>
    </tr>
    <tr>
      <td>Place</td>
      <td><label for="textfield4"></label>
      <input type="text" name="textfield4" id="textfield4" value="<?php echo $row[5]; ?>" /></td>
    </tr>
    <tr>
      <td>Post</td>
      <td><label for="textfield5"></label>
      <input type="text" name="textfield5" id="textfield5" value="<?php echo $row[6]; ?>" /></td>
    </tr>
    <tr>
      <td>Pin</td>
      <td><label for="textfield6"></label>
      <input type="text" name="textfield6" id="textfield6" value="<?php echo $row[7]; ?>" /></td>
    </tr>
    <tr>
      <td>Mob</td>
      <td><label for="textfield7"></label>
      <input type="text" name="textfield7" id="textfield7" value="<?php echo $row[8]; ?>" /></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><label for="textfield8"></label>
      <input type="text" name="textfield8" id="textfield8" value="<?php echo $row[9]; ?>" /></td>
    </tr>
    <tr>
...
if(isset($_POST["button"]))
{
	...
	$gd=$_POST["textfield9"];
	mysql_query("update studentreg set Name='$name',Age='$age',Gender='$gd',Housename='$hn',Place='$place',Post='$post',Pin='$pin',Mob='$mob',Email='$email' where lid='$idd'");
